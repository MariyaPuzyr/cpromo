                        	...
                        	<tr>
								...
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_feedback_newMessage_introText', ['#msg_number' => $ext['msg_number']]); ?>
								</p>
									...
									<td colspan="2">
                                                                ...
                                                                <a href="<?= Yii::app()->createAbsoluteUrl('/support'); ?>" target="_blank" class="btn-block" style="margin-top: 1.5rem;"><?= Yii::t('core', 'btn_open'); ?></a>
                                                            </div>
							</td>
                                                    </tr>
                                                </table>
