                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
                                                                <h3 class="h4"><?= Yii::t('core', 'mail_feedback_newMessage_subject'); ?></h4>
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_feedback_newMessage_introText', ['#number' => $ext['number']]); ?>
								</p>
								<table style="border: 1px solid #DDDDDD; width: 100%; padding: 1rem;">
                                                                    <tr>
									<td style="width: 40%" class="fontSmall"><strong><?= Yii::t('core', 'mail_defFeedbackNumber'); ?>:</strong></td>
									<td class="fontSmall"><?= $ext['number']; ?></td>
                                                                    </tr>
                                                                    <tr>
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_defDate'); ?>:</strong></td>
                                                                        <td  class="fontSmall"><?= $ext['date']; ?></td>
                                                                    </tr>
                                                                    <tr>
									<td colspan="2">
                                                                            <span style="text-align: center; font-weight: bold; display: block;"><?= Yii::t('core', 'mail_defFeedbackText'); ?>:</span>
                                                                            <span style="text-align: justify"><?= $ext['text']; ?></span>
                                                                        </td>
                                                                    </tr>
