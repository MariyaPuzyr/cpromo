                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
                                                                <h3 class="h4"><?= Yii::t('core', 'mail_feedback_changeStatus_subject'); ?></h4>
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_feedback_changeStatus_introText', ['#msg_number' => $ext['msg_number'], '#msg_status' => $ext['msg_status']]); ?>
								</p>
                                                            </div>
							</td>
                                                    </tr>
