                        	...
                        	<tr>
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
                                                                <h3 class="h4"><?= Yii::t('core', 'mail_register_subject'); ?></h4>
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_register_introText'); ?>
								</p>
								<table style="border: 1px solid #DDDDDD; width: 100%; padding: 1rem;">
									...
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_defIP'); ?>:</strong></td>
                                                                    ...
                                                                    <tr>
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_login'); ?>:</strong></td>
									<td class="fontSmall"><?= $ext['login']; ?></td>
                                                                    </tr>
                                                                    <tr>
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_register_password'); ?>:</strong></td>
									<td class="fontSmall"><?= $ext['pass']; ?></td>
                                                                    </tr>
                                                                    <tr>
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_register_referral_id'); ?>:</strong></td>
									<td class="fontSmall"><?= $ext['referral_id']; ?></td>
                                                                    </tr>
                                                                    <tr>
