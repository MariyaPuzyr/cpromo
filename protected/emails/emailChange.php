					...
					<hr class="headerHR"/>
                        	...
                        	<tr>
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
                                                                <h3 class="h4"><?= Yii::t('core', 'mail_changeEmail_subject'); ?></h4>
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_changeEmail_introText'); ?>
								</p>
								<table style="border: 1px solid #DDDDDD; width: 100%; padding: 1rem;">
									...
									<td class="fontSmall"><?= $ext['key']; ?></td>
                                                                    </tr>
								</table>
								<a href="<?= Yii::app()->controller->createAbsoluteUrl('/user/profile/changeEmail', ['change' => true, 'old_email' => $ext['old_email'], 'new_email' => $ext['new_email'], 'key' => $ext['key']]); ?>" target="_blank" class="btn-block" style="margin-top: 1.5rem;"><?= Yii::t('core', 'btn_changeEmail_short'); ?></a>
                                                            </div>
							</td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="top" style="padding-bottom: 0.2rem; padding-top: 0rem">
                                                                <div>
                                                                    <em>Copyright &copy; <?= date('Y').' '.Yii::app()->name.', '.Yii::t('controllers', 'landing_rights');?></em>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
