					...
					<hr class="headerHR"/>
                        	...
                        	<tr>
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
                                                                <h3 class="h4"><?= Yii::t('core', 'mail_invite_subject'); ?></h4>
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_invite_introText'); ?>
								</p>
								<table style="border: 1px solid #DDDDDD; width: 100%; padding: 1rem;">
									...
									<td class="fontSmall"><?= $ext['referral_name']; ?></td>
                                                                    </tr>
                                                                    <tr>
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_defRefEmail'); ?>:</strong></td>
                                                                        <td  class="fontSmall"><?= $ext['referral_email']; ?></td>
                                                                    </tr>
                                                                    <tr>
								...
								<a href="<?= Yii::app()->controller->createAbsoluteUrl('/register?referral_id='.$ext['referral_id'].'&email='.$ext['email']); ?>" target="_blank" class="btn-block" style="margin-top: 1.5rem;"><?= Yii::t('core', 'mail_btn_inviteRegister_short'); ?></a>
                                                            </div>
							</td>
                                                    </tr>
                                                </table>
