					...
					<hr class="headerHR"/>
                        	...
                        	<tr>
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
                                                                <h3 class="h4"><?= Yii::t('core', 'mail_sellOrder_subject'); ?></h4>
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_sellOrder_introText', ['#number' => $ext['number'], '#count' => $ext['count'], '#summ' => $ext['summ']]); ?>
								</p>
								<table style="border: 1px solid #DDDDDD; width: 100%; padding: 1rem;">
									...
									<td class="fontSmall"><?= $ext['time'] ?></td>
                                                                    </tr>
                                                                    <tr>
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_defIP'); ?>:</strong></td>
                                                                    ...
                                                                    <tr>
									<td class="fontSmall"><strong><?= Yii::t('core', 'mail_defClient'); ?>:</strong></td>
									<td class="fontSmall"><?= Yii::app()->request->getUserAgent(); ?></td>
                                                                    </tr>
								</table>
								<a href="<?= Yii::app()->controller->createAbsoluteUrl('/login'); ?>" target="_blank" class="btn-block" style="margin-top: 1.5rem;"><?= Yii::t('core', 'btn_login_big'); ?></a>
                                                            </div>
							</td>
                                                    </tr>
                                                </table>
