                ...
                <tr>
					...
					<hr class="headerHR"/>
                        	...
                        	<tr>
                                                ...
                                                <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div>
                                                                <h3 class="h4"><?= Yii::t('core', 'mail_confirmEmail_subject'); ?></h4>
								<br />
                                                                <p style="text-align: justify;">
                                                                    <?= Yii::t('core', 'mail_confirmEmail_introText'); ?>
								</p>
								...
								<a href="<?= Yii::app()->controller->createAbsoluteUrl('/user/profile/confirmEmail', ['email' => $ext['email'], 'activkey' => $ext['activkey']]); ?>" target="_blank" class="btn-block" style="margin-top: 1.5rem;"><?= Yii::t('core', 'btn_confirmEmail_short'); ?></a>
                                                            </div>
							</td>
                                                    </tr>
                                                </table>
