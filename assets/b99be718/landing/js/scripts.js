    ...
    *===================================*/
    $('.tk_countdown_time').each(function() {
        ...
        $(this).countdown(endTime, function(tm) {
            $(this).html(tm.strftime('<span class="counter_box"><span class="tk_counter days">%D </span><span class="tk_text">Дней</span></span><span class="counter_box"><span class="tk_counter hours">%H</span><span class="tk_text">Часов</span></span><span class="counter_box"><span class="tk_counter minutes">%M</span><span class="tk_text">Минут</span></span><span class="counter_box"><span class="tk_counter seconds">%S</span><span class="tk_text">Секунд</span></span>'));
        });
    });
	    ...
	    $.ajax({
	        ...
	        success: function(data) {
	        	if(data == '1') {
	        		...
	        		$("#alert-msg").html("Не все поля заполнены");
	        	}
	        	else {
	        		$("#alert-msg").addClass("alert-msg-success");
	                $("#alert-msg").removeClass("alert-msg-failure");
	                $("#alert-msg").html("Сообщение успешно отправлено");
	        	}
	            $("#alert-msg").show();
	        },
