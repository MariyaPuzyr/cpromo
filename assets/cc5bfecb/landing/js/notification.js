...
var countries = ['eng_flage','rus_flage','chn_flage','frn_flage'];
...
function notification() {
    spop({
        template: '<div class="sale_notification d-flex align-items-center"><img src="assets/images/about_icon.png" alt="" /> <div class="notification_inner"> <h3> $ '+Math.floor(Math.random()*2000 + 500)+' </h3><p>Покупка <img src="assets/images/'+countries[Math.floor(Math.random()*7)]+'.png" alt="" /></p></div></div>',
        group: 'submit-satus',
