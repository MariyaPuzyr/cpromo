...
<div class="row justify-content-md-center grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title"><?= Yii::t('controllers', 'support_index_btn_addMessage'); ?></h4>
            <?php
...
<div class="row gutters">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 grid-margin stretch-card">
        <div class="card bg-white border-none">
            <div class="card-body">
                <h4 class="card-header pl-0"><?= Yii::t('controllers', 'support_index_btn_listMessages'); ?></h4>
                <?php 
...
<div class="row gutters">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
        <div class="card bg-white border-none">
            <div class="card-body">
                <h4 class="card-header pl-0"><?= Yii::t('controllers', 'support_index_lbl_faq'); ?></h4>
