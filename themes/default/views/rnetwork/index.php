...
<div class="row gutters">
    <div class="col-md-8 col-sm-8">
        <h4 class="font-weight-bold text-center-mobile"><?= Yii::t('controllers', 'rnetwork_index_lbl_status', ['#status' => SprStatuses::model()->findByPk(Yii::app()->user->model()->status_account)->{'name_'.Yii::app()->language}, '#link' => Yii::app()->user->model()->status_account != Users::STATUSMAX ? CHtml::link('<span class="fas fa-arrow-circle-up small text-primary"></span>', '#', ['id' => 'buyStatusLink_Rnetwork', 'data-toggle' => 'tooltip', 'title' => Yii::t('controllers', 'rnetwork_index_btn_statusUp')]) : '']); ?></h4>
    </div>
    <div class="col-md-2">
        <button class="border bg-white btn btn-light btn-block mb-1-mobile" type="button" id="statusInfo" csrf="<?= Yii::app()->request->getCsrfToken(); ?>">
            <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true" id="spinner_status"></span>
            <?= Yii::t('controllers', 'rnetwork_index_btn_statusInfo').' <i class="icon-arrow-right" style="vertical-align: text-bottom;"></i>'; ?>
        </button>
    </div>
    <div class="col-md-2">
        <button class="border bg-white btn btn-light btn-block" type="button" id="levelInfo" csrf="<?= Yii::app()->request->getCsrfToken(); ?>">
            <span class="spinner-border spinner-border-sm d-none" role="status" aria-hidden="true" id="spinner_level"></span>
...
<div class="row gutters justify-content-md-center mt-3">
                    ...
                    <div class="stats-widget-body">
                        <ul class="row no-gutters">
                            <li class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col">
                                <h6 class="title"><?= Yii::t('controllers', 'rnetwork_index_lbl_countRefs'); ?></h6>
                            </li>
                            <li class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col">
                                <h4 class="total"><?= $countRelations; ?></h4>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="stats-widget-body">
                        <ul class="row no-gutters">
                            <li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
                                <h6 class="title"><?= Yii::t('controllers', 'rnetwork_index_lbl_countRefsBalance'); ?></h6>
                            </li>
                            <li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
                                <h4 class="total"><?= number_format($fullbalance,2,".","").'$';?></h4>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="stats-widget">
                    ...
                    <div class="stats-widget-body">
                        <ul class="row no-gutters">
                            <li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
                                <h6 class="title"><?= Yii::t('controllers', 'rnetwork_index_lbl_countRefsCoins'); ?></h6>
                            </li>
                            <li class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col">
                                <h4 class="total"><?= $fullcoins.'CP';?></h4>
                            </li>
                        </ul>
                    </div>
                </div>
